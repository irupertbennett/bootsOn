    ...
    return (
        <div className="collapse navbar-collapse w-100" id="navbarSupportedContent">
            <ul className="navbar-nav w-100 justify-content-center">  
                {/*<li className="nav-item"><NavLink className="nav-link" to='/calculator'>Create Backpack</NavLink></li>*/}
                {/*<li className="nav-item"><NavLink className="nav-link" to='/backpack'>BACKPACK</NavLink></li>*/}
                ...
                {}
                <li className="nav-item" onClick={action}><NavLink className="nav-link px-4 text-md-center" to='/addProduct'><i className="fa fa-plus" aria-hidden="true"></i><span className="d-md-block d-sm-inline"><span className="pl-3 d-md-none"></span>PRODUCT</span></NavLink></li>
            </ul>
